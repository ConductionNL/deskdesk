...
const BUNDLE_PATH = path.join(APP_ROOT, 'js', 'deskdesk-main.js')

/**
 * Ensure the webpack bundle exists before specs hit `/apps/deskdesk`.
 *
 ...
 * `npm run build`. On a fresh CI VM the `js/deskdesk-main.js`
