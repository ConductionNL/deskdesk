...
/**
 * Prometheus metrics endpoint for DeskDesk (ADR-006).
 *
...
class MetricsController extends Controller
{
     ...
     * @var string
     */
    private const METRIC_PREFIX = 'deskdesk';
    ...
    public function index(): DataDisplayResponse
    {
        try {
            ...
            $this->logger->error('DeskDesk: metrics generation failed', ['exception' => $e]);
